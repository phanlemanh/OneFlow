...
if (strings.length !== 35) fail(`expected 35 plain string entries, got ${strings.length}`);
...
console.log("OK: 35 plain strings under default org + 4 origin entries (" + ids.join(", ") + ")");
'
