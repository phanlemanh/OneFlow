...
Task 4's runner-wiring tests (`reuse`, cache counters, `node_cached`
emission, end-of-run sweep -- AC-9..12, AC-16) live in
`test_cache_runner_wiring.py`, split out once this file's own line count
crossed the 800 cap (fix round 1).
