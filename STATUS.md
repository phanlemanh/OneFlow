...
- **Nghiên cứu 26/08 — mở hoá + Director trường kỳ (ĐÃ VẬT CHẤT HOÁ):** [ADR-0013](docs/adr/0013-director-truong-ky.md) (nền trạng thái bốn tầng, memory hai chủ quyền, học derived-first, 10 lằn ranh đỏ; ghi 4 quyết định của Manh 26/08 — slug hạ tầng riêng, chấp-nhận-rủi-ro plan replay thành văn, media-library entity endpoint mặc định có, đồng ý phép thử cache-key). Bằng chứng: [research-director-truong-ky-2026-08.md](docs/strategy/research-director-truong-ky-2026-08.md) + [research-mo-hoa-2026-08.md](docs/strategy/research-mo-hoa-2026-08.md) (bản đồ 23 mảnh ghép thị trường, làn B mở hoá 8 bước). Lộ trình: **làn D** mới trong [roadmap.md](docs/roadmap.md) (xen kẽ, không nối đuôi). Ô khám phá mới: [`_acceptance/director-wire-shape/`](_acceptance/director-wire-shape/opportunity.md) (D0, Cổng 0 chưa ký); [`director-v2`](_acceptance/director-v2/opportunity.md) giữ nguyên nghĩa sản phẩm, giả định #1 sửa nền phép thử + #3 kiểm một nửa. ⚠️ Hai việc làn B chưa quyết, đứng trước mọi tag `v*`: B01 dọn pháp lý/định tuyến (NOTICE, FUNDING, SECURITY, desktop-release.yml) và B02 provenance 3 plugin port (chi tiết §3 research mở hoá).
