...
- **4 nhánh chưa về `main`** (đo lại 08/09, sau khi B2 và B3 hạ cánh): `fix/t1-escape-doi-hoi-artifact-ho-so` (2, → S1), `chore/roadmap-alias-guard` (1), `draft/bo-phan-loai-token` (1), `chore/acceptance-ci-recheck-all` (1) — cả bốn park, giữ nguyên trên ổ.
...
- **Nền tảng:** fork TongFlow (AGPL-3.0). SDK `oneflow-sdk` 0.2.23 trên PyPI, import `tongflow`; B4 (09/09) sửa engine trong kho mà không bump — bản vá tới tay người `pip install` ở chuyến phát hành SDK sau.
- **Làn D — Director trường kỳ ([ADR-0013](docs/adr/0013-director-truong-ky.md), 26/08):** khảo sát 26/08 vật chất hoá "agent là giao diện" thành nền trạng thái bốn tầng + học derived-first. Bằng chứng: [research-director-truong-ky-2026-08.md](docs/strategy/research-director-truong-ky-2026-08.md), [research-mo-hoa-2026-08.md](docs/strategy/research-mo-hoa-2026-08.md). Lộ trình: mục **Làn D** trong [roadmap.md](docs/roadmap.md) (xen kẽ, không nối đuôi). **Gói D0 đã đi hết ba cổng người** — [`_acceptance/director-wire-shape/`](_acceptance/director-wire-shape/opportunity.md): Cổng Đáng 26/08, Cổng 2 08/09 (`status: signed-off`), Cổng Giá trị 08/09 (`verdict: release`, xem [uat-session.md](_acceptance/director-wire-shape/uat-session.md) — 5 prompt tiếng Việt, 5 dòng sổ, 0 mồ côi). Hai thước còn trống vì bộ đo ghim lỗi thời: tỉ lệ thành công và p95. Chi tiết bàn giao: [HANDOFF.md](_acceptance/director-wire-shape/HANDOFF.md).
