...
## Hiện trạng (2026-09-08, sau khi hạ cánh D0 Director wire-shape — dòng B3 của kế hoạch ✅)
...
- **39 hồ sơ đã ký** (guard sổ cái xanh 39/39, 08/09); cả 39 đã trên `main` — `director-wire-shape` hạ cánh 08/09 qua PR #111. Hai hồ sơ ký ngày 04/09 đã hạ cánh: `khong-noi-sai-ve-kho-khoa` (PR #95) và `hang-rao-doc-nham-loi-thanh-khong-co-gi` (PR #96).
