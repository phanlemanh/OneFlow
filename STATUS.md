...
## Hiện trạng (2026-08-05, sau CI-a)
...
2. **Plugin TTS ElevenLabs (Phase 1.4, [ADR-0009](docs/adr/0009-tts-vi-eleven-v3.md))** — pattern API-plugin; entry origin thứ hai, cân nhắc mang theo "gói nợ lần fork đầu tiên" (mục Nợ).
