...
Round 3 (this round) re-ran every eval on the rebased tree. E1–E10 and E14 share
one invocation of `config:executors.test.sdk_pytest_packaging`; the resolved
command was run verbatim for the recorded exit status and again with `-v` (a
reporter flag, so selection and outcome are unchanged) purely to make the test
names visible. Each block below names the specific test that covers its
criterion, taken from that `-v` listing, and every one of the eleven is
individually PASSED — **no eval is credited to the shared exit status alone.**
Each test's docstring names its AC, and I re-extracted those docstrings from
`sdk/tests/test_packaging.py` this round rather than trusting the function names
or the earlier rounds' mapping: the eleven tests carry AC-1 through AC-10 and
AC-13, one apiece, which is exactly the eleven evals credited here.

- eval: E1
  run_id: sdk-distribution-rename-r3-E1-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
  output: |
    ...........                                                              [100%]
    11 passed in 2.84s
...
- eval: E2
  run_id: sdk-distribution-rename-r3-E2-20260726033729
  exit_code: 0
...
- eval: E3
  run_id: sdk-distribution-rename-r3-E3-20260726033729
  exit_code: 0
  baseline: green — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E4
  run_id: sdk-distribution-rename-r3-E4-20260726033729
  exit_code: 0
  baseline: green — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E5
  run_id: sdk-distribution-rename-r3-E5-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E6
  run_id: sdk-distribution-rename-r3-E6-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E7
  run_id: sdk-distribution-rename-r3-E7-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E8
  run_id: sdk-distribution-rename-r3-E8-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E9
  run_id: sdk-distribution-rename-r3-E9-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E10
  run_id: sdk-distribution-rename-r3-E10-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E14
  run_id: sdk-distribution-rename-r3-E14-20260726033729
  exit_code: 0
  baseline: red — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest_packaging
  verified_at: 2026-07-26T03:37:29Z
...
- eval: E11
  run_id: sdk-distribution-rename-r3-E11-20260726033735
  exit_code: 0
  baseline: green — round 1, carried forward; NOT re-measured this round
  verifier: config:executors.test.sdk_pytest
  verified_at: 2026-07-26T03:37:35Z
  output: |
    ..................................................................       [100%]
    66 passed in 3.55s

- eval: E12
  run_id: sdk-distribution-rename-r3-E12-20260726033808
  exit_code: 0
  baseline: green — round 1, carried forward; NOT re-measured this round
...
- eval: E13
  run_id: sdk-distribution-rename-r3-E13-20260726033801
  exit_code: 0
  baseline: green — round 1, carried forward; NOT re-measured this round
...
**No A/B baseline was measured in round 3.** Every `baseline:` value above is
...
and this round exists only to re-pin evidence to the current tree — so the
...
Round-3 independent spot-check, freshly performed on this tree (outside the eval
...
feature that binds it, with distinct `run_id`s per feature. Biome now checks 353
files where round 2 saw 342, and that delta reconciles exactly: the diff from the
round-2 pin to HEAD adds 15 `measure-harness` files, of which 11 are TypeScript
(5 under `scripts/measure/`, 6 under `src/lib/measure/`) and 4 are `.txt` WER
fixtures biome does not check — 342 + 11 = 353. The extra files are another
feature arriving beside this one in the rebased tree, not a change to anything
this feature owns.
